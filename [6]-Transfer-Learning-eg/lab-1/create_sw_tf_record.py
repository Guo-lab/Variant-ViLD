...
flags.DEFINE_string('label_map_path', 'data/sw_label_map.pbtxt', 'Path to label map proto')
FLAGS = flags.FLAGS
...
def main(_):
  ...
  train_output_path = os.path.join(FLAGS.output_dir, 'sw_train.record')
  val_output_path = os.path.join(FLAGS.output_dir, 'sw_val.record')
